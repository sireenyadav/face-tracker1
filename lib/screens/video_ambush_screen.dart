...
class _VideoAmbushScreenState extends State<VideoAmbushScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Bottom Layer: The RTCVideoView rendering the local camera feed.
          // It's wrapped in IgnorePointer and AnimatedOpacity.
          Positioned.fill(
            child: IgnorePointer(
                      ...
                      Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Observer Feed Active - Returning to background in',
